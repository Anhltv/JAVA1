    ...
    */
    public static void main(String[] args) {
        ...
        EX-lover 2:
            ...
            Cân nặng: 50
            Quê quán: BN
            Sở thích: Không thích ăn
            Gioi Tinh: Nữ
            Trường: Bk
        */
        
        //Phần 1: Khai báo sử dụng lớp đối tượng, cần biết tên đối tượng và vị trí
        NguoiYeuCu nyc1;//Khai báo 1 đối tượng
        nyc1 = new NguoiYeuCu();//Khởi tạo 1 đối tượng và mới sử dụng được.
        //Để gán giá trị sử dụng phương thức set
        nyc1.setTen("Nguyễn Thị A");
        nyc1.setNs(2000);
        //....
